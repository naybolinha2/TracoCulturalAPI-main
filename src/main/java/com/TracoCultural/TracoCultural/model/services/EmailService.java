...
public class EmailService {
    ...
    public void enviarEmailRedefinicaoSenha(String email, String codigo) {
        ...
        try {
            ...
            helper.setSubject(
                    "Redefinição de senha - Traço Cultural"
            );
            ...
            String html =
                    ...
                    "<p>Recebemos um pedido para redefinir a senha da sua conta no <b>Traço Cultural</b>.</p>" +

                    "<p>Digite o código abaixo no app para criar uma nova senha:</p>" +
                    ...
                    "<p>Se você não pediu essa redefinição, ignore este email — sua senha continua a mesma.</p>" +
