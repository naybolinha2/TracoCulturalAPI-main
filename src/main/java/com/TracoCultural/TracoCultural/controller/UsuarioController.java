...
public class UsuarioController {
    ...
    public ResponseEntity<Object> listarPorId(@PathVariable String id) {
        ...
        try {
            ...
            return ResponseEntity.ok(
                    new UsuarioDTO(usuarioServices.findById(Long.parseLong(id)))
            );
    ...
    public ResponseEntity<Object> SalvarUsuario(@RequestBody Usuario usuario) {
        ...
        if (!EmailDomainValidator.dominioValido(usuario.getEmail())) {
            ...
            return ResponseEntity.badRequest()
                    .body(Map.of(
                            "status", 400,
                            "message", "O domínio do email informado não existe"
                    ));
        }
    ...
    public ResponseEntity<Object> atualizarUsuario(
        ...
        try {
            ...
            return ResponseEntity.ok(
                    new UsuarioDTO(
                            usuarioServices.update(Long.parseLong(id), usuario)
                    )
            );
    ...
    public ResponseEntity<Object> atualizarSenha(
        ...
        try {
            ...
            usuarioServices.atualizarSenha(
                    Long.parseLong(id),
                    body.get("senhaAtual"),
                    body.get("novaSenha")
            );
